        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Nurse Paysheet</h2>
                </div>
                <div class="card-body">
                    <form action="NurseMonthlyPaySlipSave" method="POST">
                                ...
                                <div class="row row-space">
                                    <div class="col-2">
                                        <div class="input-group-desc">
											<h4><b><%= nurse.getDate() %></b></h4>
                                            <input class="input--style-5" type="hidden" name="date" value="<%= nurse.getDate() %>">
                                        </div>
                                    </div>
						...
						<div class="form-row m-b-55">
                            ...
                            <div class="value">
                                <div class="row row-space">
                                    <div class="col-2">
                                        <div class="input-group-desc">
										<h4><b><%= nurse.getId() %></b></h4>
                                            <input class="input--style-5" type="hidden" name="id" value="<%= nurse.getId() %>">
                                        </div>
                                    </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="name" value="<%= nurse.getName() %>" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="designation" value="<%= nurse.getDesignation() %>"
                	required >
                                </div>
                            </div>
                        </div>
						<div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="number" name="basicSalary" value="<%= String.format("%.2f",nurse.getBasicSalary()) %>"
                			min="0" step=".01"
                	required >
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="number" name="overtime" value="<%= String.format("%.2f",nurse.getOvertime()) %>"
                			min="0" step=".01"
                	required >
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="number" name="medical" value="<%= String.format("%.2f",nurse.getMedical()) %>"
                			min="0" step=".01"
                	required>
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="number" name="bonus" value="<%= String.format("%.2f",nurse.getBonus()) %>"
                			min="0" step=".01"
                	required>
                                </div>
                            </div>
						...
						<div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="number" name="other" value="<%= String.format("%.2f",nurse.getOther()) %>"
                			min="0" step=".01"
                	required>
                                </div>
                            </div>
						...
						<div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="deductionDescription" value="<%= nurse.getDeductionDescription() %>"
                	required>
                                </div>
                            </div>
                        </div>
						<div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="number" name="deductionTotal" value="<%= String.format("%.2f",nurse.getDeductionTotal()) %>"
                			min="0" step=".01"
                	required>
                                </div>
                            </div>
						...
						<div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="number" name="TotalEarnings" value="<%= String.format("%.2f",nurse.getTotalEarnings()) %>"
                			min="0" step=".01"
                	required>
                                </div>
                            </div>
						...
						<div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="netPay" value="<%= String.format("%.2f",nurse.getNetpay()) %>"
                			min="0" step=".01"
                	required>
                                </div>
                            </div>
